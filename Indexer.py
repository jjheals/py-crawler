...
class Indexer: 
    ...
    index_path = f"{Paths.JSONS_DIR}/{Crawler.index_json}"                      
    num_terms_path = f"{Paths.JSONS_DIR}/{Crawler.num_terms_json}"              
    outbound_links_path = f"{Paths.JSONS_DIR}/{Crawler.outbound_links_json}"    
    articles_path = f"{Paths.JSONS_DIR}/{Crawler.articles_json}"
